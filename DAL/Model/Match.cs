...
namespace DAL.Model
{
    ...
    public partial class Match
    {
        ...
        public override string ToString() => $"{FifaId}, {Venue}";
    }
    ...
    public partial class Match
    {
        public static List<Match> FromJson(string json) => JsonConvert.DeserializeObject<List<Match>>(json, DAL.Model.Converter.Settings);
    }
